...
public class CLASCCDBTest {

	public static void main(String[] args) {

		JDBCProvider provider = CcdbPackage.createProvider("mysql://ccdb_user@localhost/ccdb");
		provider.connect();

		// to check the table exists
		System.out.println(
				"/test/test_vars/test_table exists? - " + provider.isTypeTableAvailable("/test/test_vars/test_table"));
		...
		System.out.println(
				"/test/test_vars/evil_table exists? - " + provider.isTypeTableAvailable("/test/test_vars/evil_table"));
